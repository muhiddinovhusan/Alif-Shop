"use client"
import ProductCard from "@/components/interested/card";
...
const Favorites = () => {
  const { FavoriteCart, removeFromFavCart } = useAddToFavCartStore()
...
console.log(FavoriteCart)
   ...
   return (
  <div>
    <h1 className="text-3xl font-medium">Избранное </h1>
    <div className="grid grid-cols-6 gap-3">
      {
        FavoriteCart.map((item , i) => (
          ...
          //   <a href={`products/${item.id}`} className='w-full h-36 bg-zinc-100 p-[1px]   rounded-md relative'>
